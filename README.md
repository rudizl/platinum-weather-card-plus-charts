...
**v2.3.1**
- Cloud cover is averaged over fifteen minutes with hysteresis on the band boundaries. Broken cloud swings the raw reading across the whole icon range within minutes; on real data from one such morning this cuts the icon changing from eight times in twenty-five minutes to once
