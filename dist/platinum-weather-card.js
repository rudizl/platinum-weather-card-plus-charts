    ...
    `}get slotRainRate(){const t=this.measuredRainRate,e=null===t?"---":t.toLocaleString(this.locale,{minimumFractionDigits:1,maximumFractionDigits:1}),i=null===t||0===t?"":t<2.5?"#4fc3f7":t<10?"#29b6f6":t<50?"#0288d1":"#01579b",o=i?`color:${i};`:"";return O`
      <li data-slot="rain_rate">
        <div class="slot">
          ...
          <div class="slot-text">${St(this.locale,this.compact?"rain_rate_compact":"rain_rate")}&nbsp;</div>
    ...
    `}get slotUvIndex(){const t=this._config.entity_uv_index,e=t?this.hass.states[t]:void 0,i=e?Number(e.state):NaN,o=void 0!==e&&"unknown"!==e.state&&"unavailable"!==e.state&&isFinite(i),n=o?String(Math.round(i)):"---",s=o?i<3?"#4caf50":i<6?"#ffc107":i<8?"#ff9800":i<11?"#f44336":"#9c27b0":"",a=s?`color:${s};`:"";return O`
      <li data-slot="uv_index">
        <div class="slot">
          ...
          <div class="slot-text">${St(this.locale,this.compact?"uv_index_compact":"uv_index")}&nbsp;</div>
    ...
    `}_renderSubElementEditor(){const t=[O`
      ...
      `];switch(this._subElementEditor){case"section_overview":t.push(this._sectionOverviewEditor());break;case"option_overview":t.push(this._optionOverviewEditor());break;case"section_warnings":t.push(this._sectionWarningsEditor());break;case"section_extended":t.push(this._sectionExtendedEditor());break;case"section_slots":t.push(this._sectionSlotsEditor());break;case"option_slots":t.push(this._optionSlotsEditor());break;case"section_daily_forecast":t.push(this._sectionDailyForecastEditor());break;case"option_daily_forecast":t.push(this._optionDailyForecastEditor());break;case"option_charts":t.push(this._optionChartsEditor());break;case"option_global_options":t.push(this._optionGlobalOptionsEditor())}return O`${t}`}_goBack(){this._subElementEditor=void 0}get _show_section_overview(){var t;return!1!==(null===(t=this._config)||void 0===t?void 0:t.show_section_overview)}get _show_section_extended(){var t;return!1!==(null===(t=this._config)||void 0===t?void 0:t.show_section_extended)}get _show_section_slots(){var t;return!1!==(null===(t=this._config)||void 0===t?void 0:t.show_section_slots)}get _show_section_daily_forecast(){var t;return!1!==(null===(t=this._config)||void 0===t?void 0:t.show_section_daily_forecast)}get _show_section_charts(){var t;return!1!==(null===(t=this._config)||void 0===t?void 0:t.show_section_charts)}getConfigBlock(t,e,i){var o;switch(t){case"overview":return O`
          <div class="section-flex edit-overview-section">
            ...
            <div>
              <ha-icon-button class="down-icon" .value=${"overview"} .path=${Ut} .disabled=${i} @click="${this._moveDown}">
              </ha-icon-button>
              <ha-icon-button class="up-icon" .value=${"overview"} .path=${Wt} .disabled=${e} @click="${this._moveUp}">
              </ha-icon-button>
              <ha-icon-button class="edit-icon" .value=${"section_overview"} .path=${Rt} @click="${this._editSubmenu}">
              </ha-icon-button>
              <ha-icon-button class="option-icon" .value=${"option_overview"} .path=${Ot} @click="${this._editSubmenu}">
              </ha-icon-button>
            </div>
          </div>
        `;case"warnings":return O`
          <div class="section-flex edit-warnings-section">
            ...
            <div>
              <ha-icon-button class="down-icon" .value=${"warnings"} .path=${Ut} .disabled=${i} @click="${this._moveDown}">
              </ha-icon-button>
              <ha-icon-button class="up-icon" .value=${"warnings"} .path=${Wt} .disabled=${e} @click="${this._moveUp}">
              </ha-icon-button>
              <ha-icon-button class="edit-icon" .value=${"section_warnings"} .path=${Rt} @click="${this._editSubmenu}">
              </ha-icon-button>
        ...
        `;case"extended":return O`
          <div class="section-flex edit-extended-section">
            ...
            <div>
              <ha-icon-button class="down-icon" .value=${"extended"} .path=${Ut} .disabled=${i} @click="${this._moveDown}">
              </ha-icon-button>
              <ha-icon-button class="up-icon" .value=${"extended"} .path=${Wt} .disabled=${e} @click="${this._moveUp}">
              </ha-icon-button>
              <ha-icon-button class="edit-icon" .value=${"section_extended"} .path=${Rt} @click="${this._editSubmenu}">
              </ha-icon-button>
              <div class="no-icon"></div>
            </div>
          </div>
        `;case"slots":return O`
          <div class="section-flex edit-slots-section">
            ...
            <div>
              <ha-icon-button class="down-icon" .value=${"slots"} .path=${Ut} .disabled=${i} @click="${this._moveDown}">
              </ha-icon-button>
              <ha-icon-button class="up-icon" .value=${"slots"} .path=${Wt} .disabled=${e} @click="${this._moveUp}">
              </ha-icon-button>
              <ha-icon-button class="edit-icon" .value=${"section_slots"} .path=${Rt} @click="${this._editSubmenu}">
              </ha-icon-button>
              <ha-icon-button class="option-icon" .value=${"option_slots"} .path=${Ot} @click="${this._editSubmenu}">
              </ha-icon-button>
            </div>
          </div>
        `;case"daily_forecast":return O`
          <div class="section-flex edit-daily-forecast-section">
            ...
            <div>
              <ha-icon-button class="down-icon" .value=${"daily_forecast"} .path=${Ut} .disabled=${i} @click="${this._moveDown}">
              </ha-icon-button>
              <ha-icon-button class="up-icon" .value=${"daily_forecast"} .path=${Wt} .disabled=${e} @click="${this._moveUp}">
              </ha-icon-button>
              <ha-icon-button class="edit-icon" .value=${"section_daily_forecast"} .path=${Rt} @click="${this._editSubmenu}">
              </ha-icon-button>
              <ha-icon-button class="option-icon" .value=${"option_daily_forecast"} .path=${Ot} @click="${this._editSubmenu}">
              </ha-icon-button>
            </div>
          </div>
        `;case"charts":return O`
          <div class="section-flex edit-charts-section">
            ...
            <div>
              <ha-icon-button class="down-icon" .value=${"charts"} .path=${Ut} .disabled=${i} @click="${this._moveDown}">
              </ha-icon-button>
              <ha-icon-button class="up-icon" .value=${"charts"} .path=${Wt} .disabled=${e} @click="${this._moveUp}">
              </ha-icon-button>
              <div class="no-icon"></div>
              <ha-icon-button class="option-icon" .value=${"option_charts"} .path=${Ot} @click="${this._editSubmenu}">
              </ha-icon-button>
            </div>
          </div>
